...
for cat_name, cat_scale, obj_names in [
        ...
        ('Doors', door_scale, [
            ...
            ('/Game/InteractiveObjects/Doors/Eden_6/Door_Eden6_VehicleSpawner/Animation/AS_VehicleDoor_Open', door_scale, 1),
            ]),
